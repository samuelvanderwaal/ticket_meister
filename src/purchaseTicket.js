...
import { Account, Connection, PublicKey, SYSVAR_RENT_PUBKEY, Transaction, TransactionInstruction } from "@solana/web3.js";
import BN from "bn.js";
import { EVENT_ACCOUNT_DATA_LAYOUT } from "./layout";
const connection = new Connection("http://localhost:8899", "singleGossip");
export const purchaseTicket = async (privateKeyByteArray, eventAccountString, eventProgramIdString) => {
