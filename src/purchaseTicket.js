...
export const purchaseTicket = async (privateKeyByteArray, eventAccountString, mintAccountString, eventProgramIdString) => {
    ...
    let associatedTokenAccountPubKey = await findAssociatedTokenAddress(initializerAccount.publicKey, mintAccountPubKey);
    ...
    const encodedEventState = (await connection.getAccountInfo(eventAccountPubKey, "singleGossip")).data;
